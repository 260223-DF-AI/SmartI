...
class Cat(Animal):
    ...
    def describe(self):
        ...
        # Set the appropriate text for the is_indoor value
        status = "indoor" if self.is_indoor else "outdoor"
        
        """
        return a description of the cat that includes
            - The part of the description that every animal in the shelter has
            - Its color
...
class Kitten(Cat):
    ...
    def __init__(self, name, age_months, color):
        ...
        ageInYears = age_months / 12

        # TODO: Call parent constructor
        super().__init__(name, ageInYears, color)
...
class Shelter:
    ...
    def find_by_name(self, name):
        ...
        for animal in self.animals: # Loops through the animals in the shelter
            if(animal.name.lower() == name.lower()): # Checks if the animal's name matches (case insensitive)
                return animal # returns the first animal who's name matches the search
        return None # No animals in the shelter had that name. Return None
    ...
    def list_available(self):
        ...
        """
        - Loops through all of the animals in the shelter
        - Checks if the animal's _adopted value
        - Adds the animals to a list if their _adopted value is False
        - Returns the list of all the animals who have not been adopted
        """
    ...
    def list_by_species(self, species):
        ...
        - Adds the animals to a list if their species match
        - Returns the list of all the animals of the species
        """
...
def main():
    ...
    # TODO: Add a Cat
    shelter.add_animal(Cat("Maomao", 3, "Tuxedo", False))

    # TODO: Add a Puppy
    shelter.add_animal(Puppy("Fredrick", 4, "Poodle"))

    # TODO: Add a ServiceDog
    shelter.add_animal(ServiceDog("Fred", 4, "French Bulldog", "therapy"))
